...
public class ContactDao extends AbstractDao<Contact, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Phone_id_contact = new Property(1, Integer.class, "phone_id_contact", false, "PHONE_ID_CONTACT");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'CONTACT' (" + //
                ...
                "'PHONE_ID_CONTACT' INTEGER," + // 1: phone_id_contact
    ...
    protected void bindValues(SQLiteStatement stmt, Contact entity) {
        ...
        Integer phone_id_contact = entity.getPhone_id_contact();
        if (phone_id_contact != null) {
            stmt.bindLong(2, phone_id_contact);
        }
    ...
    public Contact readEntity(Cursor cursor, int offset) {
        Contact entity = new Contact( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getInt(offset + 1), // phone_id_contact
    ...
    public void readEntity(Cursor cursor, Contact entity, int offset) {
        ...
        entity.setPhone_id_contact(cursor.isNull(offset + 1) ? null : cursor.getInt(offset + 1));
